...
//       Filename:  mempool.h
// 
//    Description:  内存池，管理多种size内存块的分配
// 
//        Version:  1.0
//        Created:  05/14/2014 11:03:01 AM
//       Revision:  none
//       Compiler:  g++
// 
//         Author:  Zhu Zilong (), zhuzilong@baidu.com
//        Company:  baidu.ecom.houyi
// 
// =====================================================================================

#ifndef __NBSLIB_MEMPOOL_H__
#define __NBSLIB_MEMPOOL_H__

#include <stdint.h>
#include <vector>
#include <algorithm>
#include <ext/hash_map>
//#include "weigou_common.h"
#include "log_util.h"

#ifndef NBS_MEM_PAGE_SIZE
#define NBS_MEM_PAGE_SIZE   (1024*1024u)
#endif
...
class Mempool
{
    ...
    public:
        ...
        int register_item(uint32_t elem_size)
        {
            ...
            if (elem_size > NBS_MEM_PAGE_SIZE)
            {
        ...
        int init(uint32_t max_items_num)
        {
            ...
            for (size_t i = 0; i < m_items.size(); ++i)
            {
                ...
                uint32_t page_size = NBS_MEM_PAGE_SIZE;
