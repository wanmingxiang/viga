...
class InvertIndex
{
    ...
    public:
        ...
        DocList *parse_v2(const std::string &query, const std::vector<term_t> &terms) const;
        DocList *parse_hp(const std::string &query, const std::vector<term_t> &terms,
                std::string *new_query = NULL) const;
        DocList *parse_hpv2(const std::string &query, const std::vector<term_t> &terms,
                std::string *new_query = NULL) const;
    ...
    private:
        ...
        int rewrite_query_terms(
                const std::string& origin_query, const std::vector<term_t>& origin_terms,
                std::string* rewrite_query, std::vector<term_t>* rewrite_terms) const;
    private:
